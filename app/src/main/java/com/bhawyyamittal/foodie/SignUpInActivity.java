...
public class SignUpInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("users_backend");
        ...
        if((!TextUtils.isEmpty(email_text)) && (!TextUtils.isEmpty(pass_text))){
            auth.createUserWithEmailAndPassword(email_text,pass_text).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    Toast.makeText(SignUpInActivity.this,"User creation successful",Toast.LENGTH_LONG).show();
                    if(task.isSuccessful()) {
                        ...
                        Intent login = new Intent(SignUpInActivity.this,Login.class);
                        startActivity(login);
                    }
    ...
    public void signIn(View view) {
        Intent loginIntent = new Intent(SignUpInActivity.this,Login.class);
